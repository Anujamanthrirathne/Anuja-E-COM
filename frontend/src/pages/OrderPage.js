...
import displayLKRCurrency from '../helpers/displayCuruncey';
    ...
    <div>
      ...
      <div className='p-4 w-full'>
        ...
        <div className='grid gap-1'>
                        ...
                        <img 
                         ...
                         className='w-28 h-28 bg-slate-200 object-scale-down p-2'
                          ...
                          <div className='font-medium text-lg text-ellipsis line-clamp-1'>{product.name}</div>
                           ...
                           <div className='text-lg text-red-500 '>{displayLKRCurrency(product.price)}</div>
            ...
            <div className='font-semibold ml-auto w-fit lg: text-lg text-red-600'>
